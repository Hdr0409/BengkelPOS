        ...
        <div class="h-full px-4 py-6 overflow-y-auto glass-sidebar border-r border-slate-800 flex flex-col justify-between">
            ...
            <div>
                <div class="flex items-center gap-3 px-4 mb-10">
                    ...
                    <div>
                        <h1 class="text-white font-bold text-xl tracking-tight leading-none">test</h1>
                        <span class="text-slate-500 text-xs font-medium uppercase tracking-widest">test</span>
                    </div>
                </div>
